...
public class UtilityBigliettoForm {
	public static Biglietto createBigliettoFromParams(String desctinazioneInputParam, String proveneinzaInputParam,
			String prezzoInputStringParam, String dataStringParam) {

		Biglietto result = new Biglietto(proveneinzaInputParam,desctinazioneInputParam);
