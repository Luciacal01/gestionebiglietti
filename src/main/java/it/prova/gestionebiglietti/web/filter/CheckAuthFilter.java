...
public class CheckAuthFilter implements Filter {
	...
	private static final String[] EXCLUDED_URLS = {"/login.jsp","/LoginServlet","/LogoutServlet","/css/","/js/", "/index.jsp", "/search.jsp", "PrepareSearchBigliettoServlet", "ExecuteSearchBigliettoServlet"};
